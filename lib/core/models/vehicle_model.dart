...
// ── VehicleInterventionModel ──────────────────────────────────────────────────
// Historique d'intervention/CT attaché à un véhicule (carnet numérique).

class VehicleInterventionModel {
  final String id;
  final String vehicleId;
  final String type; // ct | repair | maintenance
  ...
  const VehicleInterventionModel({
    required this.id,
  ...
  factory VehicleInterventionModel.fromJson(Map<String, dynamic> json) =>
      VehicleInterventionModel(
        id:           json['id'] as String,
        vehicleId:    json['vehicle_id'] as String,
        type:         json['type'] as String? ?? 'ct',
